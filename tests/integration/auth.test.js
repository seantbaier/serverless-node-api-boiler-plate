...
describe('Auth routes', () => {
  describe(`POST ${baseUrl}/auth/register`, () => {
    let newUser
    beforeEach(() => {
      newUser = {
  ...
  describe(`POST ${baseUrl}/auth/refresh-tokens`, () => {
  ...
  describe(`POST ${baseUrl}/auth/forgot-password`, () => {
    beforeEach(() => {
  ...
  describe(`POST ${baseUrl}/auth/reset-password`, () => {
